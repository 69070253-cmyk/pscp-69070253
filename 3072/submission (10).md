...
```text
input : รับค่าเป็น str เข้ามา
output : ต้องการให้นับตัวที่เป็นสระ และบอกว่ามีตัวอะไรบ้าง
constraints : -
```
...
```text
step 1 : รับค่า string เข้ามาและปรับให้เป็นตัวเล็กทั้งหมด
step 2 : จากนั้นใช้ for loop  เพื่อลูปตัว a e i o u
step 3 : สร้างอีกตัวแปรมาเก็บค่า count เพื่อนับตัวในลูปว่าตรงไหม
step 4 : if count  > 0  หมายความว่าถ้ามีตัวใน count มากกว่า 0 ตัว ให้ปริ้นค่า count ออกมา
```
...
```text
ใช้แบบวิธีแรก ใช้ loop เพื่อเช็คว่ามี aeiou ครบไหม
```
...
```text
เพื่อเช็คว่าจะแสดงค่าได้ครบทุกตัวไหม
```
...
```text
เพื่อดูว่าถ้ามีสระไม่ครบทุกตัวจะแสดงตัวที่ไม่มีออกมาไหม
```
...
```text
ดูว่าถ้ามีหลายตัวจะแสดงออกมาครบไหม
```
