...
```text
input : นำเข้าตัวอักษรเข้ามา และรับหมายเลขเข้ามา โดยใช้แบบ split 
output : แสดงเงินรางวัลออกมา
constraints : -
```
...
```text
step 1 : รับค่า input มา 1 ตัวและทำเป็น split และกำหนดค่าตัวแปรเพิ่ม เป็น 0
step 2 : กำหนดเงื่อนไขแรกมาก่อนว่า ถ้าตัวอักษรทั้งสองตัวเหมือนกัน จากนั้นใข้เงื่อนไขอีกรอบข้างใน 1.ถ้า เลขเหมือนกันหมดเลย ให้แสดงเลข 1000000 ออกมา 2.ตัวเลข 3 ตัวหลังเหมือนกัน  3. ตัวเลข 2 ตัวหลังเหมือนกัน และถ้าไมม่มีเหมือนกันสักตัว
step 3 : เงื่อนไขใหญ่เงื่อนไขแรก ใช้ else ก็จะเป็นถ้า ตัวอักษรไม่เหมือนกัน จากนั้นเงื่อนไขภายในใช้เหมือนกับขั้นแรกเลย แต่เปลี่ยนเลขให้ตรงตามโจทย์
step 4 : จากนั้น print แสดงผบค่าตัวแปรออกมา
```
...
```text
ทำแบบวิธ๊แรก กำหนดก่อนว่าถ้าตัวอักษรแรกเหมือนกันจะใข้เงื่อนไขไหน จากนั้นใช้ string slicincg ในการเลือก 3 ตัวหลังกับ 2 ตัวหลัง
```
...
```text
ถ้าถูกทั้งหมดเลย ทั้งตัวเลขตัวอักษรจะแสดงออกมาถูกต้องไหม
```
...
```text
เช็คว่าถ้าตัวอักษรถูก แต่ตัวเลขไม่ถูก จะแสดงออกมาได้ถูกไหม
```
...
```text
เช็คว่าถ้าไม่มีอะไรถูกเลขจะแสดงออกมาได้ถูกต้องไหม
```
