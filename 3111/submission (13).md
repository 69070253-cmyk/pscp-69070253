...
```text
input : รับสถานะว่ามีสมาชิกไหมเป็น str  จากนั้นรับว่าซื้อของกี่ชื้นหลังจากนั้นก็รับราคาของที่ซื้อ
output : ราคาที่ได้หลังจากผลรวมของสินค้าทั้งหมดที่ลดราคาไปแล้วเป็นทศนิยม 2 ตย.
constrains : ปัดทศนิยมขึ้นหลังจากเลข 5 ขึ้นไป
```
...
```text
step 1 : รับตัว str และก็รับจำนวนสินค้า หลังจากนั้นใช้ loop รับจำนวนสินค้าและ input ราคาแต่ละตัวมาตามจำนวนสินค้า
step 2 : จากนั้นสร้างตัวแปรมารับ list และก็ list ราคาสินค้าแต่ละอย่างเอาไว้ใน list หลังจากนั้น sum ราคาสินค้าทั้งหมด
step 3 : จากนั้นสร้างงื่อนไขสมาชิกตามที่โจทย์กำหนด
step 4 : แปลงเลขเป็นทศนิยม โดยการนำ ราคาทั้งหมดที่รวมส่วนลดแล้ว * 1000 แล้วบวกเพิ่ม 0.005 และก็แสดงผลออกมาเป็นทศนิยม 2 ตน.
```
...
```text
เหมือนวิธีแรก ยกเว้น step 4 แก้จาก total * 1000 เป็น str(f"{total:.3f}")[-1] >= "5" เปลี่ยนตัวรับเป็น str และกำหนดทศนิยมตน.ที่ 3 จากนั้นใช้ [-1] เพื่อเช็คตัวสุดท้ายว่าใช่ 5 ไหม ถ้าใช่ให้บวกเพิ่ม 0.005
```
...
```text
เพื่อเช็คว่า ถ้าเป็นทศนิยมตน.ที่ 3 ตัวสุดท้ายเป็น 5 จะบวกเพิ่มเข้าไปไหม
```
...
```text
เพื่อดูว่าถ้าไม่มีสมาชิกและมากกว่า 500 จะได้ส่วนลดไหม
```
...
```text
เช็คว่าถ้าไม่ถึง 500 และไม่มีสมาชิก จะออกเป็นค่าปกติไหม
```
...
```text
ช่วยแก้ทศนิยม .5 ขึ้นไปไม่ปัดขึ้นให้
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดเองทั้งหมด วางแผนการเขียนเอง
```
