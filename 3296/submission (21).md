...
```text
input : รับค่าสีมา บรรทัดละ 3 สี โดยมี 2 บรรทัด
output : แสดงผลลัพท์จากการผสมสีออกมา โดยมีช่องว่างกั้นไม่ให้คิดตอบชิดกัน
```
...
```text
นำสีของแต่ละแถวที่ตรงกันมาบวกกัน แล้วใช้ // เพื่อให้หารลงตัว จากนั้น print ออกมาโดยการคั่นด้วย , จากคำตอบแต่ละตัว
```
...
```text
ใช้เหมือนแผนแรก การนำแต่ละแถวที่ตรงกันมาบวกกันแล้วหาร จากนั้นแสดงค่าทุกตัวออกมาโดยมี ลูกน้ำ คั่นแต่ละคำตอบตอนที่ print 
```
...
```text
ทดลองว่าถ้ารับ 0 หมด จะออกมาเป็น 0 ไหม
```
...
```text
เพื่อเช็คว่าปัดเศษถูกต้องทุกตัวไหม
```
