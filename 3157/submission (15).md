...
```text
input : ตัวแรกต้องการรับเลขจำนวนเต็มเพื่อมาบอกว่าจะมีอีกกี่ตัว ต่อมาใส่ข้อความตามจำนวนที่ตัวแรกกำหนด
output : ผลรวมทั้งหมด
constraints : เป็น " + " ต้องเพิ่ม 10 คะแนน เป็น " - " ลด 5 คะแนน
```
...
```text
step 1 : รับค่า input ตัวแรกเข้ามาก่อน และก็กำหนดตัวแปรเปล่าเป็น 0
step 2 : จากนั้นใช้ loop รับ input ตัวแรกมาเพื่อกำหนดค่าตามจำนวนตัวที่เข้ามา
step 3 : ใช้ if ในการกำหนดว่า input ตัวที่ 2 เป็น + ให้บวกค่าเข้าไป 10 จากนั้นใช้ elif เช็คว่าถ้าเป็น - ให้ลดค่าไป 5
step 4 : จากนั้น print ค่าทั้งหมดที่ททำการคำนวณออกมา
```
...
```text
แผนเดียวกับแบบแรก รับค่าเข้ามา  ใช้ if elif เช็คเงื่อนไขที่กำหนดแล้วเก็บค่าตัวเลข +,- ไว้ในตัวแปร int เปล่า
```
...
```text
เช็คว่าสามารถแสดงค่าออกมาได้ตามที่โจทย์กำหนด
```
...
```text
เพื่อเช็คว่าถ้ามี 2 เงื่อนไขพร้อมกันจะมาสามารถแสดงค่าออกมาได้ถูกต้องตามที่กำหนด
```
