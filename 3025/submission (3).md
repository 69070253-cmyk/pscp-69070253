...
```text
โจทย์ให้รับวันและเดือนมา และให้เปลี่ยนเป็นฤดูกาล
input : รับค่าวันและเดือนเป็นจำนวนเต็ม
output : ให้แสดงฤดูกาลออกมาตามเดือนที่กำหนด
Contraints : ตอนแรกรับค่า / แทน % ทำให้ค่าที่ออกมามีแต่ตัวเดิมๆ
```
...
```text
step1 : รับค่าวันและเดือนเข้ามา
step2 : ใส่เงื่อนไขว่า ถ้าตรงกับเดือนที่ 1,2,3 จะปริ้นฤดูนี้ออกมา
step3 : กำหนดให้วันที่ 21 ของเดือนที่  3 หารลงตัวเปลี่ยนเป็นฤดูอื่น
```
...
```text
ทำคล้ายเดิมแต่
step1 : จะกำหนดให้เช็คก่อนว่าเป็นวันที่ >= 21 หรือไม่และก็เช็คว่าเป็นเดือนที่ 3 หารลงตัวไหม
step2 : แล้วค่อยมาใส่เงื่อนไขว่า ถ้าตรงกับเดือนที่ 1,2,3 จะปริ้นฤดูนี้ออกมา
```
...
```text
เพื่อเช็คว่าโค้ดที่เขียนสามารถรันออกได้
```
...
```text
เพื่อดูว่าเงื่อนไขที่ใช้ถูกต้องและเปลี่ยนฤดูให้จริงๆ
```
...
```text
เพื่อดูว่าจะไม่มีค่าอะไรออกมา เผื่อกรณีที่กำหนดผิด
```
