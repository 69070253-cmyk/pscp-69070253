...
| OJ submission ID, if submitted | 630704 |
| OJ status | Pass |
...
```text
ให้สอนวิธีใช้ list อย่างละเอียดและสอนวิธีการใช้ loop ในการหา split ในหลายๆ ตัวโดยที่ไม่รู้ตัวแปรที่แน่นอน
```
...
```text
ai ช่วยในการสังเกตุว่าถ้าใช้ loop กับ split จะทำให้สามารถรับค่าที่ไม่รู้ตัวแปรแน่นอนได้
```
...
```text
ฉันแก้โค้ดเป็นภาษาที่ฉันเข้าใจเอง 
```
...
```text
เรียนรู้การใช้ for loop มากขึ้นและเรียนรู้ขั้นตอนในการใช้ควบคู่กับ split ได้ดีขึ้น
```
