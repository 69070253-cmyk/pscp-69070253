...
```text
โจทย์ให้ตัวอักษรมาแล้วให้มาสลับ
input : ให้รับข้อความ str มา
output : แสดงค่าออกมาเป็นตัวพิมพ์เล็ก และสลับตัวอักษร
constraints : ต้องเปลี่ยนจากตัวพิมพ์ใหญ่มาเป็นตัวพิมพ์เล็ก
```
...
```text
เหมือน เพร่าะว่า ข้อนี้ต้องการแค่ให้เปลี่ยนเป็นพิมพ์เล็กกับสลับข้อความ
```
...
```text
เพราะว่าเป็นตัวพิมพ์ใหญ่ทั้งหมดเพื่อเช็คว่ามันจะแก้เป็นพิมพ์เล็กหมดไหม
```
...
```text
เช็คว่ามันสลับได้ตรงไหมและเป็นพิมพ์เล็กหมด  
```
