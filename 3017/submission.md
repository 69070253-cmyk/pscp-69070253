...
```text
โจทย์ให้หาค่าผลรวมของราคาทั้งหมดไปรวมกับ service charge กับ vat 7%
input : จำนวนเงินของราคาอาหารทั้งหมด
output : ค่าที่ออกมาหลังจากนำจำนวนเงินที่ได้จากราคาอาหารทั้งหมดไปรวมกับ service + vat 
constraints : ลืมกำหนดว่า service charge ขั้นต่ำ 50
```
...
```text
1.รับค่าราคาอาหารทั้งหมดเข้ามาเป็น int 
2.กำหนด service ขึ้นมาเพื่อกำหนดค่า service charge 
3.กำหนดว่าถ้ามีค่า service ต่ำกว่า 50 บาทให้ปรับเป็น 50 บาท และถ้าเกิน 1000 ให้ปรับเป็น 1000
4.นำตัวที่กำหนดทั้งหมดมารวมเป็น total เพื่อปริ้นออกมาให้ตรงกับที่โจทย์ต้องการ
```
...
```text
เหมือน  แค่เพิ่มทศนิยม 2 ต่ำแหน่ง มาจากวิธีแรก
```
...
```text
เพื่อเช็คว่าถ้า service น้อยกว่า 50 จะปรับค่าเป็น 50 ตามที่กำหนดไหม
```
...
```text
เพื่อเช็คว่าถ้า service มากกว่า 1000 จะปรับค่าเป็น 1000 ไหม
```
...
```text
ช่วยบอกวิธีในการกำหนดค่า service ว่าถ้ามันน้อยกว่า 50 จะกำหนดให้เป็น 50 ได้ยังไง
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียน code วางแผนขั้นตอนต่างๆเอง
```
