...
```text
input : รับค่าเป็น split มา รับเป็นจำนวนเต็ม
output : แสดงทุกตัวที่เป็นจำนวนเฉพาะ จากนั้นนับว่ามีจำนวนเฉพาะทั้งหมดกี่ตัว
constraints : เลขที่แสดงต้องเป็นจำนวนเฉพาะ
```
...
```text
step 1 : รับค่า split ออกมา จากนั้นกำหนดตัวแปรที่ 1 และตัวที่ 2 และก็สร้างตัวแปร list เปล่าเอาไว้
step 2 : จากนั้นใช้ loop ในการ กำหนดตั้งแต่ตัวแปรที่ 1 ถึงตัวที่ 2 
step 3 : จากนั้นกำหนดให้ i > 1 และกำหนด ให้ถ้าตัวที่อยู่ใน i มีเลข 2,3,5,7 หรือ ตัวที่หาร 2,3,5,7 ไม่ลงตัว จากนั้นเก็บใน list
```
...
```text
ต่อจากวิธ๊แรก หลังจากเพื่อนช่วยอธิบายวิธ๊
ต่อมาแปลงค่า  i  ทุกตัวเป็น str และก็กำหนดว่าถ้ามีเลขใน list ให้ print เลขออกมาแล้วก็ขั้นแต่ละตัวด้วยช่องว่างขั้นตอนสุดท้ายนับค่าใน str ทั้งหมดที่มี
```
...
```text
เพื่อเช็คว่าจะนับค่า 2 3 5 7 ว่าเป็นจำนวนเฉพาะไหม และก็เช็คว่ามีครบ 4 ตัวตามที่แสดงออกมาไหม
```
...
```text
เพื่อดูว่าถ้าเลขหลังจากที่กำหนดไป จะแสดงค่าเป็รชนจำนวนเฉพาะออกมาไหม
```
...
```text
เช็คว่าแสดงออกมาได้ถูกต้องและครบ
```
...
```text
ช่วยบอกวีธีแปลงค่าใน list ออกมาเป็น str ยังไง
```
