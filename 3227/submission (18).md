...
```text
input : ต้องการรับค่าเป็นตัวอักษร หรือตัวเลข 2 -10
output : ต้องการแสดงค่าตัวชือของไพ่แต่ละตัวจากตัวย่อของ input
constraints : ถ้าเขียนแบบเต็มๆอาจยาวไป
```
...
```text
step 1 : รับค่า input เข้ามาและใช้ function upper เพื่อให้ตัวใหญ่ทุกรอบที่รับเข้ามา 
step 2 : จากนั้นกำหนดตัวแปรเพิ่ม กำหนดตัวแรกว่า ไม่เอาแค่ตัวท้ายโดยใช้ slicing จากนั้นกำหนดอีกตัวแปรเอาแค่ ตัวท้ายอย่างเดียว
step 3 : จากนั้นสร้าง dic ไว้ 2 อัน เพื่อกรอกค่าที่จำเป็น เพื่อให้แปลงได้ง่ายขึ้น
step 4 : เช็คเงื่อนไช ถ้าค่าที่กำหนดอยู่ใน dic และถูกต้อง จากนั้นแสดงผลและดึงค่า dic ออกมา และกั้นด้วย "of"
step 5 : เช็คเงื่อนไขอีกอันถ้าไม่ได้อยู่ใน dic แต่มีค่าระหว่างตัวเลข 2 - 10 จะนำตัวเลขนั้นมาใช้ จากนั้นแสดงผลออกมากั้นด้วย "of"
```
...
```text
ทำแบบวิธีแรก เก็บค่าที่ต้องใช้ไว้ใน dic จากนั้น แยก 2 เงื่อนไข ที่ไม่มีเลขและเงื่อนไขที่มีเลข จากนั้นแสดงผลออกมาโดยดึงค่าที่เขียนไว้ใน dic มาใข้
```
...
```text
เพื่อตรวจสอบว่าแสดงค่าใน dic ออกมาได้ถูกต้องและถูกตัว
```
...
```text
เพื่อตรวจสอบว่าถ้าเป็นตัวเลขจะแสดงออกมาถูกตัวไหม
```
...
```text
เพื่อเช็คว่าถ้าเกินขอบเขตจะแสดงผลอะไรออกมาไหม
```
